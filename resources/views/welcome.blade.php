...
<head>
    ...
    <title>Welcome Database Ftk</title>
...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="pl-4 flex items-center">
                <a class="toggleColour text-black no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    href="#">
                    Selamat Datang Di Database Fakultas Teknik Dan Kejuruan
                </a>
            </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <a href="{{ url('/dashboard') }}"
                        class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">Dashboard</a>
                    @else
                    <a href="{{ route('login') }}"
                        class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">Log
                        in</a>
    ...
    <div class="pt-24">
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <h1 class="my-4 text-5xl font-bold leading-tight">Ini Adalah Website Dengan menggunakan Livewire</h1>
                <p class="leading-normal text-2xl mb-8">Silahkan Melakukan Login Atau Register Terlebih Dahulu</p>
    ...
    <section class="bg-gray-100 py-8">
        ...
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">Data Diri</h1>
            <div class="w-full mb-4">
                <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
                ...
                <div
                    ...
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="w-full p-8 text-3xl font-bold text-center">Ketut Gede Subiksa</div>
                        <div class="h-1 w-full gradient my-0 py-0 rounded-t"></div>
                        <ul class="w-full text-center text-base font-bold">
                            <li class="border-b py-4">1915101007</li>
                            <li class="border-b py-4">Ilmu Komputer 4A</li>
                            <li class="border-b py-4">Semester 4</li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <h3 class="my-4 text-3xl leading-tight"></h3>
